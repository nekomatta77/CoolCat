...
export default function App() {
  ...
  // ОБНОВЛЕННЫЙ ЭКРАН ЗАГРУЗКИ С УМЕНЬШЕННОЙ ИКОНКОЙ И АНИМАЦИЕЙ ПРЫЖКА
  if (loading) {
    return (
