...
export const AVATARS = [
  ...
  // За уровни
  { id: '/assets/avatars/storm.webp', type: 'avatar', name: 'Гроза', unlockType: 'level', unlockValue: 6, config: { x: 0, y: 0, scale: 1 } },
  
  // За достижения: DICE
  { id: '/assets/avatars/ava_dice.webp', type: 'avatar', name: 'DICE CAT', unlockType: 'achievement', unlockValue: 'dice_fb1', config: { x: 0, y: 0, scale: 1 } },
  { id: '/assets/avatars/nine.webp', type: 'avatar', name: '9 Жизней', unlockType: 'achievement', unlockValue: 'dice_nine_lives', config: { x: 0, y: 0, scale: 1 } },
  
  // За достижения: MINES
  { id: '/assets/avatars/bomb.webp', type: 'avatar', name: 'Кот-сапёр', unlockType: 'achievement', unlockValue: 'mines_sapper3', config: { x: 0, y: 0, scale: 1 } },
  { id: '/assets/avatars/find.webp', type: 'avatar', name: 'Искатель', unlockType: 'achievement', unlockValue: 'mines_kitty4', config: { x: 0, y: 0, scale: 1 } },
  { id: '/assets/avatars/astrocat.webp', type: 'avatar', name: 'Астрокот', unlockType: 'achievement', unlockValue: 'mines_infinity2', config: { x: 0, y: 0, scale: 1 } },
  
  // За достижения: KENO
  { id: '/assets/avatars/brain_cat.webp', type: 'avatar', name: 'Счастливое число', unlockType: 'achievement', unlockValue: 'keno_lucky_num', config: { x: 0, y: 0, scale: 1 } },
  { id: '/assets/avatars/magic_cat.webp', type: 'avatar', name: 'Маг', unlockType: 'achievement', unlockValue: 'keno_nostracat', config: { x: 0, y: 0, scale: 1 } },
  ...
  { id: '/assets/avatars/meditation_cat.webp', type: 'avatar', name: 'Терпение', unlockType: 'achievement', unlockValue: 'wx_why_not', config: { x: 0, y: 0, scale: 1 } },
  
  // За достижения: ARENA
  { id: '/assets/avatars/fight_cat.webp', type: 'avatar', name: 'Арена', unlockType: 'achievement', unlockValue: 'arena_underdog', config: { x: 0, y: 0, scale: 1 } }
];
