...
export const FRAMES = [
  ...
  // НАСТРОЙКА РАМКИ DICE:
  // scale: масштаб рамки (увеличьте, чтобы сделать ее шире/выше, например 1.25 или 1.35)
  // x, y: смещение по осям X и Y в процентах (например, y: -5 поднимет рамку относительно центра)
  { 
    id: 'dice_frame', 
    name: 'Рамка DICE', 
    css: 'border-transparent', 
    img: '/assets/frame/dice_frame.webp', 
    config: { scale: 1.4, x: -2, y: 0 }, 
    unlockType: 'achievement', 
    unlockValue: 'dice_cat_sense' 
  },
];
